...
/* harmony export */ });
var sliders = document.querySelectorAll('.wash__slider');
var initBannerSlider = function initBannerSlider() {
  sliders.forEach(function (slider) {
    ...
    var handleMode = function handleMode() {
      var isTwo = slider.classList.contains('wash__slider--two');
...
var Modals = /*#__PURE__*/function () {
  ...
  _createClass(Modals, [{
    ...
    value: function open(modalName) {
      ...
      // Автозакрытие для модалки "thanks" "congrat"
      if (modalName === 'thanks' || modalName === 'congrat') {
        setTimeout(function () {
          return _this.close(modalName);
        }, 4000);
      }
      setTimeout(function () {
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  input.addEventListener('input', function () {
    ...
    input.value = value;
    // Активируем кнопку, если всё заполнено
    submitBtn.disabled = value.length !== MAX_LENGTH;
  });
