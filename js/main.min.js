...
var Modals = /*#__PURE__*/function () {
  function Modals() {
    var _this$_settings$this$, _this$_settings$this$2, _this$_settings$this$3, _this$_settings$this$4, _this$_settings$this$5, _this$_settings$this$6, _this$_settings$this$7, _this$_settings$this$8, _this$_settings$this$9;
    ...
    this._preventDefault = (_this$_settings$this$ = this._settings[this._settingKey]) === null || _this$_settings$this$ === void 0 ? void 0 : _this$_settings$this$.preventDefault;
    this._stopPlay = (_this$_settings$this$2 = this._settings[this._settingKey]) === null || _this$_settings$this$2 === void 0 ? void 0 : _this$_settings$this$2.stopPlay;
    this._lockFocus = (_this$_settings$this$3 = this._settings[this._settingKey]) === null || _this$_settings$this$3 === void 0 ? void 0 : _this$_settings$this$3.lockFocus;
    this._startFocus = (_this$_settings$this$4 = this._settings[this._settingKey]) === null || _this$_settings$this$4 === void 0 ? void 0 : _this$_settings$this$4.startFocus;
    this._focusBack = (_this$_settings$this$5 = this._settings[this._settingKey]) === null || _this$_settings$this$5 === void 0 ? void 0 : _this$_settings$this$5.focusBack;
    this._eventTimeout = ((_this$_settings$this$6 = this._settings[this._settingKey]) === null || _this$_settings$this$6 === void 0 ? void 0 : _this$_settings$this$6.eventTimeout) || 0;
    this._resetScrollPos = (_this$_settings$this$7 = this._settings[this._settingKey]) === null || _this$_settings$this$7 === void 0 ? void 0 : _this$_settings$this$7.resetScrollPos;
    this._openCallback = (_this$_settings$this$8 = this._settings[this._settingKey]) === null || _this$_settings$this$8 === void 0 ? void 0 : _this$_settings$this$8.openCallback;
    this._closeCallback = (_this$_settings$this$9 = this._settings[this._settingKey]) === null || _this$_settings$this$9 === void 0 ? void 0 : _this$_settings$this$9.closeCallback;
    this._documentKeydownHandler = this._documentKeydownHandler.bind(this);
    this._documentClickHandler = this._documentClickHandler.bind(this);
    this._modalClickHandler = this._modalClickHandler.bind(this);
    this._init();
    this._initCookieModal(); // автоматическое открытие cookie-модалки
  }
  _createClass(Modals, [{
    key: "_init",
    ...
    value: function _setSettings() {
      ...
      if (!settings) return;
      this._preventDefault = typeof settings.preventDefault === 'boolean' ? settings.preventDefault : this._preventDefault;
      this._stopPlay = typeof settings.stopPlay === 'boolean' ? settings.stopPlay : this._stopPlay;
      this._lockFocus = typeof settings.lockFocus === 'boolean' ? settings.lockFocus : this._lockFocus;
      this._startFocus = typeof settings.startFocus === 'boolean' ? settings.startFocus : this._startFocus;
      this._focusBack = typeof settings.focusBack === 'boolean' ? settings.focusBack : this._focusBack;
      this._resetScrollPos = typeof settings.resetScrollPos === 'boolean' ? settings.resetScrollPos : this._resetScrollPos;
      this._eventTimeout = typeof settings.eventTimeout === 'number' ? settings.eventTimeout : this._eventTimeout;
      this._openCallback = settings.openCallback || this._openCallback;
      this._closeCallback = settings.closeCallback || this._closeCallback;
    }
  }, {
    key: "_documentClickHandler",
    value: function _documentClickHandler(evt) {
    ...
    value: function open() {
      ...
      if (this._lockFocus) this._focusLock.lock('.modal.is-active', this._startFocus);
      if (this._resetScrollPos) modal.scrollTo(0, 0);

      // Добавляем автоматическое закрытие для модалки thanks
      if (modalName === 'thanks') {
        setTimeout(function () {
          _this.close('thanks');
        }, 4000);
    ...
    value: function back() {
      ...
      if (this._stackModalElements.length === 1) this._stackModalElements = [];
      if (prevModal) {
    ...
    value: function close() {
      ...
      this._enableScrolling = true;
      setTimeout(function () {
        return document.addEventListener('click', _this2._documentClickHandler);
      }, this._eventTimeout);
    }
  }, {
